...
1. **Clone the repository**
    ...
    ```bash
    git clone https://github.com/your-username/kirana-tally.git
    cd kirana-tally
    ```
...
│   ├── common/          # distinct buttons, inputs, etc.
│   ├── layout/          # Main wrapper and navigation structures
│   └── ...
├── context/             # React Contexts (AuthContext, etc.)
├── pages/               # Main application views (Dashboard, Inventory, Billing, etc.)
